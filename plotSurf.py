...
# file_met=['/home/rvalenzuela/SURFACE/case03/bby01023.met',
# 			'/home/rvalenzuela/SURFACE/case03/bby01024.met']

file_met=['/home/rvalenzuela/SURFACE/case03/czc01023.met',
			'/home/rvalenzuela/SURFACE/case03/czc01024.met']

name_col=['press','temp','rh','wspd','wdir','precip','mixr']

# index_col=[3,6,9,10,12,17,26] # bby
index_col=[3,4,5,6,8,13,23] # czc
...
def parse_dataframe(file_met):
	...
	meteo=dframe.ix[:,index_col]
	meteo.index=dates
	meteo.columns=name_col
